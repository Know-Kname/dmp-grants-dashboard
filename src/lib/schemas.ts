...
export const workOrderTypeSchema = z.enum(
  ["maintenance", "burial_prep", "grounds", "repair", "other"],
  {
...
export const grantStatusSchema = z.enum(
  ["available", "applied", "approved", "denied", "received"],
  {
    errorMap: () => ({ message: "Invalid status" }),
  },
);
...
export const contractStatusSchema = z.enum(
  ["active", "paid", "cancelled", "transferred"],
  {
    errorMap: () => ({ message: "Invalid status" }),
  },
);
...
export const paymentMethodSchema = z.enum(
  ["cash", "check", "credit_card", "wire", "other"],
  {
